    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const totalSpent = userOrders
          .filter(order => order.status !== 'CANCELLED') // Exclude cancelled orders from total spent
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
                              <button className="relative p-3 text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-full transition-colors duration-200">
